...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr dontbreak="true">
            ...
            <td style="text-align: center">@if(!is_null($invoice->currency)){!! htmlentities($invoice->currency->currency_symbol)  !!}@else ₹ @endif{{ number_format((float)$invoice->total, 2, '.', '') }}</td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
    <hr>
    <p id="notes">
        @lang("app.note"): Here @if(!is_null($invoice->currency)){!! htmlentities($invoice->currency->currency_symbol)  !!}@else ₹ @endif refers to {!! $invoice->currency->currency_code  !!}<br>
    </p>
