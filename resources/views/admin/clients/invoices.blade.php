            ...
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6"> <strong>@lang('app.mobile')</strong> <br>
                        <p class="text-muted">{{ $clientDetail->mobile ?? 'NA'}}</p>
                    </div>
                </div>
                <hr>
                <div class="row">
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="{{ route('admin.clients.projects', $client->client_details->user_id) }}"><span>@lang('app.menu.projects')</span></a>
                                <li class="tab-current"><a href="{{ route('admin.clients.invoices', $client->client_details->user_id) }}"><span>@lang('app.menu.invoices')</span></a>
                                </li>
