                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        ...
                                        <h3 class="box-title m-b-0">@lang('app.faq') @lang('app.menu.settings')</h3>
                                        <hr>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="javascript:;" class="btn btn-outline btn-success btn-sm addFeature">@lang('app.add') @lang('app.faq') <i class="fa fa-plus" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                @forelse($frontFaqs as $frontFaq)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <a href="javascript:;" data-feature-id="{{ $frontFaq->id }}" class="btn btn-info btn-circle editFeature"
                                                               data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                            <a href="javascript:;" class="btn btn-danger btn-circle sa-params"
                                                               data-toggle="tooltip" data-feature-id="{{ $frontFaq->id }}" data-original-title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                 @empty
                                                    <tr>
