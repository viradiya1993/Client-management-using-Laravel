...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            @if($allModules)
                <a href="{{ route('super-admin.custom-modules.create') }}" class="btn btn-success btn-sm btn-outline"><i class="fa fa-refresh"></i> @lang('app.install')/@lang('app.update') @lang('app.module')</a>
            @endif
            <ol class="breadcrumb">
