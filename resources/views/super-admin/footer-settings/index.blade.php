                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="javascript:;" class="btn btn-outline btn-success btn-sm addFeature">@lang('modules.footer.addFooter') <i class="fa fa-plus" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                @forelse($footer as $footerMenu)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <a href="javascript:;" data-feature-id="{{ $footerMenu->id }}" class="btn btn-info btn-circle editFeature"
