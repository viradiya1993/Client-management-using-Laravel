                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" value="{{ $frontDetail->testimonial_title }}">
                                                </div>
                                            </div>
                                        </div>
                                        {{--<div class="row">--}}
                                            {{--<div class="col-sm-12 col-xs-12">--}}
                                                {{--<div class="form-group">--}}
                                                    ...
                                                    {{--<textarea class="form-control" id="detail" rows="5" name="detail">{{ $frontDetail->testimonial_detail }}</textarea>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
