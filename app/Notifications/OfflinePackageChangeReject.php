...
class OfflinePackageChangeReject extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Your request for '.$this->planChange->package->name. ' ('.$this->planChange->package_type.') is rejected due to wrong details.')
