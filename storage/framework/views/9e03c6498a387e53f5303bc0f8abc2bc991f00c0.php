...
<div class="container">
    <div class="row" style="margin-top: 30px">
        <div class="text-center m-t-20 mt-20">
            <img class="text-center" src="<?php echo e(asset('img/worksuite-logo.png')); ?>" style="max-width: 240px" alt="Home"/>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Server Requirements.
                    <?php if(version_compare(PHP_VERSION, '7.1.3') > 0): ?>
...
<?php /**PATH /var/www/html/ClientManagment/ClientManagment/codecanyon-23263417-worksuite-saas-project-management-system/resources/views/vendor/froiden-envato/install_message.blade.php ENDPATH**/ ?>